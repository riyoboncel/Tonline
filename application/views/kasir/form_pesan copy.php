          ...
          <div class="col-12 col-sm-8 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-text"><input type="text" size="2" class="form-control" id="KdCust" name="KdCust" value="<?php echo $faktur->KdCust ?>" required placeholder="Ketik Kode / Nama Cust"></span>

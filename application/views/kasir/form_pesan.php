                    ...
                    <?php foreach ($list->result() as $key) : ?>
                      <tr align="left">
                        ...
                        <td>
                          ...
                          <input class="form-control-sm" name="brg" type="text" size="30" disabled value="<?php echo $key->NamaBrg ?>" />
                        </td>
                        <td>
...
<div class="modal fade" id="modalAgree" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="col-10">
        <form action="<?php echo base_url('kasir/form-pesan/') . $faktur->NoPesanJual . "/"  ?>" method="post">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#KdSales').autocomplete({
      source: "<?php echo base_url('kasir/get_autocomplete_sales/?'); ?>",
      select: function(event, ui) {
  ...
  $("#KdSales").keypress(function(e) {
    ...
    if (e.which == 13) {
      if (kd_sales) {
        window.top.location.href = "<?php echo base_url('kasir/ceksales/') ?>" + nofak + "/" + kd_sales;
      }
      return false;
    }
  });

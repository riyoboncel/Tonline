          ...
          <div class="invoice p-3 mb-2">
            ...
            <div class="row">
              ...
              <div class="col-12">
                ...
                <?php echo $faktur->NoPesanJual ?>&nbsp; | &nbsp;Cust: <?php echo $faktur->NmCust ?>
              </div>
              <div class="col-12">
                <div class="info-box mb-2">
                  ...
                  <div class="info-box-content input-group-sm">
                    ...
                    <input type="text" class="form-control" id="KdCust" name="KdCust" value="<?php echo $faktur->KdCust ?>" required placeholder="Ketik Kode / Nama Cust">
                    ...
                    <?php foreach ($list->result() as $key) : ?>
                      <tr align="left">
                        ...
                        <td>
                          ...
                          <input name="brg" type="text" disabled value="<?php echo $key->NamaBrg ?>" />
                        </td>
                        <td>

...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">PESAN PENDING</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            <tbody>
              <?php foreach ($selesai->result() as $key) : ?>
                <tr>
                  ...
                  <td>
                    <form action="<?php echo base_url('kasir/kirimprint/') ?>" method="POST">
                      <input type="hidden" name="nofak" value="<?php echo $key->NoPesanJual ?>">
                      <input type="submit" value="Kirim Wa">
                    </form>
                  </td>
                </tr>
              <?php endforeach ?>

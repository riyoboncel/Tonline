          ...
          <div class="col-12 col-sm-8 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-text"><input type="text" size="2" class="form-control" id="KdCust" name="KdCust" value="<?php echo $faktur->KdCust ?>" required></span>
                <span class="info-box-number"><input type="text" size="5" readonly class="form-control" id="nm_cust" name="nm_cust" value="<?php echo $faktur->NmCust ?>" placeholder="Cari Customer">
                </span>
      ...
      <div class="col-12">
        ...
        <div class="callout callout-info">
          ...
          <div class="form-horizontal">
            <div class="form-group">
              <label class="control-label col-sm-4" for="KdBrg">Kode Barang</label>
              <div class="col-sm-4">
                <input type="hidden" name="nofak" id="nofak" value="<?php echo $faktur->NoPesanJual ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" readonly class="form-control" id="nm_barang" name="nm_barang" placeholder="Cari Nama Barang">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="invoice p-3 mb-3">
              ...
              <table class="table table-striped">
                ...
                <?php foreach ($list->result() as $key): ?>   
                    <tr> 
                              ...
                              <?php echo $key->NamaBrg ?></td> 
                              <td><form action="<?php echo base_url('kasir/edit_jumlah_beli/') ?>" method="post">
                              ...
                              <td><form action="<?php echo base_url('kasir/edit_harga_jual/') ?>" method="post">
                              ...
                              <td><form action="<?php echo base_url('kasir/edit_kdsales/') ?>" method="post">
                              ...
                              <td><a onclick="return confirm('Yakin hapus data ini?');" href="<?php echo base_url('kasir/hapus-barang-beli/') . $key->NoPesanJual . "/" . $key->KdBrg ?>"><p style="color: red"><i class="fa fa-times"></i></p></a></td>                 
                    </tr>
                    <?php
                    $tot_item += $key->Jumlah;
          ...
          <div class="row no-print">
            ...
            <div class="col-6">
              <a href="<?php echo base_url('kasir/form-pesan/') . $faktur->NoPesanJual . "/"  ?>"><button type="button" class="btn btn-primary float-right" style="margin-right: 5px;">
              <i class="fas fa-cart-plus fa-lg mr-2"></i> Tambah Barang
              </button></a>
            </div>
          </div>
        </div>
                    ...
                    <div class="form-group">
                            <select class="form-control"  name="sat" id="sat" required>
                              ...
                              <?php 
                                ...
                                if($key->Sat_3 <> ''){
                                  ?><option value="<?php echo $key->Sat_3 ?>"><?php echo $key->Sat_3 ?></option><?php
                                }
                                if($key->Sat_4 <> ''){

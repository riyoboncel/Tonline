            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Grafik Pesan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            foreach ($report as $result) {
                $nama[] = substr($result->NmBrg, 0, 15);
                $value[] = (float) $result->Akhir;
            }
            ?>
...
<footer class="main-footer">
    <strong> &copy; 2020 &nbsp; Design &nbsp; By &nbsp;<a href="http://estoh.id" target="_blank">Estoh Software </a></strong>

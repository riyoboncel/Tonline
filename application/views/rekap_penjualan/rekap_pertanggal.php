                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Rekap Penjualan Per<?php echo $judul; ?></h5>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="form-inline" action="<?php echo base_url('rekap_jual/rekap_penjualan_pertanggal/') ?>" method="post">
                ...
                <div class="card-header">
                    ...
                    <div class="col-12 table-responsive">
                        ...
                        <table id="example1" class="table table-striped">
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($rekap as $tt => $key) : ?>
                                    <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><?php echo $key->Keterangan ?></td>
                                        <td><?php echo number_format($key->Total, 0, ',', '.') ?></td>
                                        <td><?php echo $key->Jumlah ?></td>
                                        <td style="text-align:right;"><?php echo number_format(($key->Total - $key->Discont - $key->Potongan + $key->PPN), 0, ',', '.') ?></td>
                                    </tr>
                                    <?php
                                    $aa += $key->Total;
                                    ?>

  ...
  <table width="250" border="0" align="center">
    <?php foreach ($produk->result() as $key) : ?>
      <tr>
        ...
        <td valign="bottom">
          <div align="right"><?php echo number_format($key->Jumlah * ($key->Harga - $key->Disc)) ?></div>
        </td>
      </tr>
      <?php
    ...
    <tr>
      ...
      <td></td>
      <td colspan="2">
        <div align="right"><?php echo number_format($faktur->PotonganRp) ?></div>
      </td>
    </tr>
    <tr>
      ...
      <td></td>
      <td colspan="2">
        <div align="right"><?php echo number_format($faktur->SubTotal - $faktur->PotonganRp) ?></div>
      </td>
    </tr>
    <tr>
      <td colspan="4" align="center">

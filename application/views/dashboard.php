    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          <div class="small-box bg-success">
            <div class="inner">
              <h3><i class="fas fa-users fa-sm mr-2"></i></h3>
              <p>Data Customer</p>
            </div>
        ...
        <div class="col-lg-3 col-6">
          <div class="small-box bg-warning">
            <div class="inner">
              <h3><i class="fas fa-cart-plus fa-sm mr-2"></i></h3>
              <p>Daftar Pesan Jual Detail</p>
            </div>
            <a href="<?php echo base_url('pesanjualdetail/daftar-pesanjualdetail') ?>" class="small-box-footer">Masuk&nbsp; <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-6">
          <div class="small-box bg-danger">
            <div class="inner">
              <h3><i class="fas fa-cart-plus fa-sm mr-2"></i></h3>
              <p>Entry Pesan Jual Cafe</p>
            </div>
            <a href="<?php echo base_url('cafe/nomor-faktur') ?>" class="small-box-footer">Masuk &nbsp; <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-info">
            ...
            <a href="<?php echo base_url('opname/nomor-faktur/') ?>" class="small-box-footer">Masuk&nbsp;<i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-success">
            <div class="inner">
              <h3>&nbsp;</h3>
              <p>Opname Via Kirim</p>
            </div>

            <a href="<?php echo base_url('opnameviakirim/nomor-faktur/') ?>" class="small-box-footer">Masuk&nbsp; <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-warning">
            <div class="inner">
              <h3><i class="fas fa-cart-plus fa-sm mr-2"></i></h3>
              <p>Antrian Faktur Jual</p>
            </div>

            <a href="<?php echo base_url('fakturjual/antrian-fakturjual') ?>" class="small-box-footer">Masuk &nbsp; <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            ...
            <a href="<?php echo base_url('fakturjual/nomor-faktur') ?>" class="small-box-footer">Masuk &nbsp; <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->

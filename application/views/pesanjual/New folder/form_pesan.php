      ...
      <div class="modal-content">
        ...
        <form action="<?php echo base_url('pesanjual/edit_satuan/') ?>" method="post">
          <div class="modal-body">
            ...
            <div class="form-group">
              <input type="number" class="form-control-sm" id="jumlah" name="jumlah" min="0" value="<?php echo $key->Jumlah ?>" required>
            </div>
            <div class="form-group">
...
<div class="modal fade" id="modalAgree" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="col-10">
        <form action="<?php echo base_url('pesanjual/form-pesan/') . $faktur->NoPesanJual . "/"  ?>" method="post">
...
<footer class="main-footer">
  <div class="col-6" style="float: left;">
    <a href="<?php echo base_url('pesanjual/antrian-pesan/') . $faktur->NoPesanJual . "/"  ?>"><button type="button" class="btn btn-primary float-right" style="margin-right: 5px;">
        <i class="fas fa-cart-plus fa-lg mr-2"></i>
      </button></a>
  </div>
  <div class="col-6" style="float: right;">
    <form class="form-inline" action="<?php echo base_url('pesanjual/go_to_simpan/') ?>" method="post">
